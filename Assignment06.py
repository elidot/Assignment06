...
#Done Add function to delete delete_ID
    @staticmethod
    def delete_cd(table):
        ...
        Args:
            table (list of dict): 2D data structure (list of dicts) that holds the data during runtime
        Returns:
            Removes data associated to ID user input held in the 2D Data structure
        """
...
class IO:
    ...
    # Added Function to get input get_input(id,title, name) 
#    @staticmethod
#    def get_UserInput(ID,Title,Artist):
...
while True:
    ...
    # 3.3 process add a CD
        ...
        # TODO - NOt working moved IO code into function
